      ...
      return [
        {
          ...
          rows: [
            ...
            [
              {
                label: this.$lang.t('s409_d001_a'),
                type: 'fieldset',
                rows: [
                  [
                    {
                      label: this.$lang.t('s409_d001_a_i'),
                      type: 'label'
                    }
                  ],
                  [
                    {
                      label: this.$lang.t('s409_d001_a_ii'),
                      type: 'label'
                    }
                  ],
                  [
